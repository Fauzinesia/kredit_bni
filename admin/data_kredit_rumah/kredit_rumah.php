...
<head>
    ...
    <title>Data Kredit Rumah - Sistem Kredit BNI</title>
            ...
            <div class="container-fluid">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">Data Kredit Rumah</h4>
                                            ...
                                            <tbody>
                                                ...
                                                if ($result && mysqli_num_rows($result) > 0) {
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        $id = isset($row['kredit_id']) ? $row['kredit_id'] : 0;
                                                        ...
                                                        echo "<td>
                                                                <div class='form-button-action'>
                                                                    ...
                                                                    <a href='hapus.php?id=" . $row['kredit_id'] . "' class='btn btn-link btn-danger btn-lg' data-toggle='tooltip' title='Hapus Data'>
                                                    ...
                                                    echo "<tr><td colspan='10' class='text-center'>Tidak ada data kredit rumah</td></tr>";
                                                }
                                                ?>
                                            </tbody>
                                        </table>
