...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $check_query = "SELECT * FROM tb_kredit_rumah WHERE kredit_id = '$id'";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        if (isset($_GET['confirm']) && $_GET['confirm'] == 'yes') {
            // Hapus data
            $delete_query = "DELETE FROM tb_kredit_rumah WHERE kredit_id = '$id'";
            if (mysqli_query($koneksi, $delete_query)) {
                $_SESSION['success'] = "Data kredit rumah berhasil dihapus!";
        ...
        <head>
            ...
            <title>Hapus Data Kredit Rumah - Sistem Kredit BNI</title>
                    ...
                    <div class="container-fluid">
                        <div class="page-inner">
                            <div class="page-header">
                                <h4 class="page-title">Konfirmasi Hapus Data Kredit Rumah</h4>
                                <ul class="breadcrumbs">
                                    ...
                                    <li class="nav-item">
                                        <a href="kredit_rumah.php">Data Kredit Rumah</a>
                                    </li>
                                    <li class="separator">
                                        <i class="fas fa-angle-right"></i>
                                    </li>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="alert alert-warning">
                                                ...
                                                <p>Anda akan menghapus data kredit rumah berikut:</p>
                                            </div>
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <a href="kredit_rumah.php" class="btn btn-secondary">
        ...
        echo "<p>Tidak ada data kredit rumah dengan ID: $id</p>";
        echo "<p><a href='kredit_rumah.php' class='btn btn-primary'>Kembali ke daftar kredit rumah</a></p>";
        echo "</div>";
        exit;
    }
} else {
    // ID tidak valid
    echo "<div style='color:red; padding:20px;'>";
    echo "<h3>Error: ID kredit rumah tidak valid!</h3>";
