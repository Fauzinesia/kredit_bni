...
<head>
    ...
    <title>Cetak Data Kredit - Sistem Kredit BNI</title>
...
<body>
    <div class="header">
        ...
        <div class="title">LAPORAN DATA KREDIT</div>
    ...
    <button class="no-print" onclick="window.location.href='kredit.php'">Kembali</button>
    ...
    <table>
        ...
        <tbody>
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                echo "<tr><td colspan='9' class='text-center'>Tidak ada data kredit</td></tr>";
            }
            ?>
        </tbody>
    </table>
